...
class BrandReturnsChart extends ChartWidget
{
    protected static ?string $pollingInterval = null;
    protected static ?string $heading = 'مرتجعات العلامة التجارية';
    ...
    protected function getData(): array
    {
        ...
        $data = app(BrandReportService::class)->getBrandReturnsChartData($this->record, $start, $end);
