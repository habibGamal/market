...
use App\Filament\Resources\ShortTermLiabilityResource\Pages;
...
class ShortTermLiabilityResource extends Resource implements HasShieldPermissions
{
    protected static ?string $model = CashSettlement::class;

    protected static ?string $navigationIcon = 'heroicon-o-arrow-down-circle';
    protected static ?string $navigationGroup = 'التسويات النقدية';
    protected static ?string $modelLabel = 'التزام قصير الأجل';
    protected static ?string $pluralModelLabel = 'التزامات قصيرة الاجل';
        ...
        return $form
            ->schema([
                Forms\Components\Hidden::make('type')
                    ->default(CashSettlementType::OUT->value),
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('type', CashSettlementType::OUT))
            ->columns([
            ...
            ->actions([
                Tables\Actions\Action::make('mark_as_paid')
                    ...
                    ->modalDescription('هل أنت متأكد من أنك تريد تحديد هذا الالتزام كمدفوع؟ سيتم تحديث الخزينة تلقائياً.')
                ...
                Tables\Actions\Action::make('mark_as_unpaid')
                    ...
                    ->modalDescription('هل أنت متأكد من أنك تريد إلغاء دفع هذا الالتزام؟ سيتم تحديث الخزينة تلقائياً.')
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    ...
                    Tables\Actions\BulkAction::make('mark_as_paid')
                        ...
                        ->modalDescription('هل أنت متأكد من أنك تريد تحديد جميع الالتزامات المحددة كمدفوعة؟ سيتم تحديث الخزينة تلقائياً.')
                    ...
                    Tables\Actions\BulkAction::make('mark_as_unpaid')
                        ...
                        ->modalDescription('هل أنت متأكد من أنك تريد إلغاء دفع جميع الالتزامات المحددة؟ سيتم تحديث الخزينة تلقائياً.')
                        ->action(function ($records) {
                            $service = app(CashSettlementService::class);
    ...
    {
        return [
            'index' => Pages\ListShortTermLiabilities::route('/'),
            'create' => Pages\CreateShortTermLiability::route('/create'),
            'edit' => Pages\EditShortTermLiability::route('/{record}/edit'),
        ];
    }
